...
//                  <p onClick={()=>navigate('my-profile')} className='hover:text-black cursor-poi' >My Profile</p>
//                  <p onClick={()=>navigate('my-appointments')}className='hover:text-black cursor-poi'>My Appointments</p>
//                  <p onClick={()=>setToken(false)} className='hover:text-black cursor-poi'>Logout</p>
//               </div>
//               </div>
//             </div>
