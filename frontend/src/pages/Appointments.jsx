...
const Appointments = () => {
  ...
  const { doctors, currencySymbol} = useContext(AppContext)  // Access the doctors data from context
...
const [slotTime,setSlotTime] = useState('')
  ...
  // Function to fetch the doctor's info
...
time: formattedTime
  ...
  // Fetch doctor's info whenever the doctors array or docId changes
  useEffect(() => {
    fetchDocInfo();
  }, [doctors, docId])
